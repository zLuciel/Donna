...
async function getDataCategoria() {
  const Abarrotes = await fetch(`http://www.doona.com.pe/api/woocommerce/products/18`);
  const Bebidas = await fetch(`http://www.doona.com.pe/api/woocommerce/products/19`);
  const Lacteos = await fetch(`http://www.doona.com.pe/api/woocommerce/products/20`);
  const Limpieza = await fetch(`http://www.doona.com.pe/api/woocommerce/products/21`);
  const Cpersonal = await fetch(`http://www.doona.com.pe/api/woocommerce/products/22`);
  const Confiteria = await fetch(`http://www.doona.com.pe/api/woocommerce/products/23`);
  if (!Abarrotes.ok) {
